      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-3 mb-4">
          ...
          <div className="bg-green-100 rounded-xl p-3">
            <div className="text-2xl font-bold text-green-800">{statusCounts.diluluskan}</div>
            <div className="text-xs text-green-600">Diluluskan</div>
          </div>
          <div className="bg-red-100 rounded-xl p-3">
            <div className="text-2xl font-bold text-red-800">{statusCounts.ditolak}</div>
        ...
        <div className="fixed bottom-4 left-4 right-4 bg-white rounded-2xl shadow-lg p-3 flex justify-around">
          ...
          <Link href="/staff-ict/kelulusan" className="flex flex-col items-center text-blue-600"><div>✅</div><div className="text-xs">Kelulusan</div></Link>
