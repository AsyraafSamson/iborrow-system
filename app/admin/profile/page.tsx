        ...
        <Card>
          <CardHeader>
            <div className="flex items-start justify-between gap-3">
              <div>
                <CardTitle>Profil Pentadbir</CardTitle>
          ...
          <CardContent className="space-y-4">
            {(['nama', 'email', 'telefon', 'jabatan'] as const).map((field) => (
              <div key={field} className="space-y-1">
                <Label className="capitalize">{field === 'telefon' ? 'No. Telefon' : field.charAt(0).toUpperCase() + field.slice(1)}</Label>
                {isEditing ? (
                  <Input
            ...
            <div className="space-y-1">
              <Label>Peranan</Label>
              <div className="rounded-md bg-muted px-3 py-2 text-sm">Administrator</div>
            </div>
          </CardContent>
        </Card>
